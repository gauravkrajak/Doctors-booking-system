...
class register:
    def __init__(self, root):
        ...
        title = Label(
            frame1,
            text="You Are Just One Step Away To Book Your Appointment With Dr. Saneha",
    ...
    def confirm(self):
        ...
        if self.var_email.get() == "":
            ...
            body = "Congratulations you have successfully booked an appointment with Dr. Saneha .\n #Time :- 4 PM(Tomorrow) .\n You have to reach on time and mask is compulsory for entry .\n Thank you"
            message = "Subject:{}\n\n{}".format(subject, body)
            print(message)
            listofAddress = e
