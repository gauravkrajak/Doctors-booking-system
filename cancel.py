...
class register:
    def __init__(self, root):
        ...
        title = Label(
            frame1,
            text="You Are Just One Step Away To Cancel Your Appointment",
    ...
    def confirm(self):
        ...
        if self.var_email.get() == "":
            ...
            print(con)
            cur = con.cursor()
            cur.execute(f"update employee SET phone='' where email = '{self.var_email.get()}' ")
            ...
            body = "You have successfully Canceled your appointment .\n To book new appointment you can go to appointment section.\n Thank you"
            message = "Subject:{}\n\n{}".format(subject, body)
            print(message)
            listofAddress = e
